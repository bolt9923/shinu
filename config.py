...
BOT_USERNAME = getenv("BOT_USERNAME" , "@TG_MUSIC_XBOT")

# Don't Add style font 
BOT_NAME = getenv("BOT_NAME" , "˹ 𝙏𝙂 ✘ 𝙈𝙐𝙎𝙄𝘾 ˼")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/bolt9923/shinu",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+Z1KURmoPcT9lNjVl")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/30mfzb.jpg"
)
PING_IMG_URL = getenv(
