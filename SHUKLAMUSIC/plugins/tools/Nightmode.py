...
async def _nightmode(_, message):
    return await message.reply_photo(photo="https://i.imghippo.com/files/Ud6932QAs.jpg", caption="**ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ᴛᴏ ᴇɴᴀʙʟᴇ ᴏʀ ᴅɪsᴀʙʟᴇ ɴɪɢʜᴛᴍᴏᴅᴇ ɪɴ ᴛʜɪs ᴄʜᴀᴛ.**",reply_markup=buttons)
    ...
    for add_chat in chats:
        try:
            await app.send_photo(
                add_chat,
                photo="https://i.imghippo.com/files/Ud6932QAs.jpg",
